            ...
            <div class="card card-primary">
              <div class="card-header">
                <div class="card-title">
                  Bukti Kehadiran Asisten Dosen Mata Kuliah SKPB
                </div>
              </div>
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="1"> Mata Kuliah 1 (WHITE) </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="2"> Mata Kuliah 2 (BLACK) </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="3"> Mata Kuliah 3 (COLORED) </a>
                  </div>
                  <div class="mb-2">
