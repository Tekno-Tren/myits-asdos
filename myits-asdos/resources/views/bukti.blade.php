                    ...
                    <div class="w-full px-4 border border-slate-300 rounded-xl mx-auto p-5 shadow-md font-inter"
                        ...
                        <form action="{{ route('bukti.store', $kelas_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-full px-4 mb-4">
                                <h1>Silahkan upload foto bukti di kelas dengan ketentuan sebagai berikut:</h1>
                                <h1 style="text-align: justify">Foto selfie diambil oleh asdos dari arah belakang sehingga
                                    mahasiswa dan materi terlihat</h1>
