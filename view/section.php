          ...
          <div class="w-full px-4 border border-slate-300 rounded-xl mx-auto p-5 shadow-md font-inter" style="background-color: aliceblue;">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="w-full px-4 mb-6 flex justify-end">
                <input type="file" id="section1" name="section1" value="section1" class="w-full bg-slate-200 text-dark p-2 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary mb-2">
